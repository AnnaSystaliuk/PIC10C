...
var TickLengthLevelOne = TimeInterval(600)
...
class GameScene: SKScene {
    ...
    override init(size: CGSize) {
        ...
        anchorPoint = CGPoint(x: 0.06, y: 0.93)
        
        let background = SKTexture(imageNamed: "wall")
        let backgroundNode = SKSpriteNode(texture: background, size: size)
        backgroundNode.anchorPoint = self.anchorPoint
        ...
        let gameBoardTexture = SKTexture(imageNamed: "transpernt")
    ...
    func animateCollapsingLines(linesToRemove: Array<Array<Block>>, fallenBlocks: Array<Array<Block>>, completion:@escaping () -> ()) {
        ...
        tickLengthMillis = tickLengthMillis - TimeInterval(50)
